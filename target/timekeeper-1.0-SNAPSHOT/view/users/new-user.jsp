...
<div class="container">
    <div class="def-table center-h center-v">
        <div class="def-row">
            <form class="def-table" action="new" method="post">
                <div class="def-table">
                    <div class="def-row">
                    ...
                    <div class="def-row">
                        <div class="def-cell bold text-big-xx def-cell">Role:</div>
                        <div class="def-cell container">
                            <select class="text-big-x width-fill" name="roleId">
                                <c:forEach items="${requestScope.list}" var="role">
                                    <option value="${role.id}">${role.name.toLowerCase()}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="def-row">
                        <div class="def-cell bold text-big-xx def-cell">Password:</div>
                        <div class="def-cell container">
                            <input class="text-big-x width-fill" name="password" required
                                   pattern="^[\sa-zA-Z0-9/.-]{4,32}$"
                                   title="Field may contain only letters, digits and !@#$%^&* - symbols. Min 4, max 32 symbols.">
                ...
                <div class="def-row container text-center">
                    ...
                    <div class="right">
                        <input class="my-button width-xx text-big-xx" btn-color="blue" type="submit" value="Create">
                    </div>
                </div>
            </form>
