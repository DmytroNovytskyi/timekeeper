    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><fmt:message key="admin.users.modal.createTitle"/></h4>
            </div>
            <div class="modal-body">
                <form class="row g-3 modalForm"
                      action="users/create" method="post" novalidate>
                    <div class="col-12 mb-3">
                        <label for="usernameCreate" class="form-label"><fmt:message
                        ...
                        <label for="emailCreate" class="form-label"><fmt:message key="admin.users.modal.email"/></label>
                        ...
                        <label for="role" class="form-label"><fmt:message key="admin.users.modal.role"/></label>
